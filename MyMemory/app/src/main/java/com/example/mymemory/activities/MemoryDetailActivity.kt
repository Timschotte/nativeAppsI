...
import kotlinx.android.synthetic.main.activity_memory_detail.*
...
class MemoryDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            val detailFragment = MemoryDetailFragment.newInstance(
                intent.getSerializableExtra(MemoryDetailFragment.ARG_MEMORY) as Memory
            )

            supportFragmentManager.beginTransaction()
                .add(R.id.memory_detail_container, detailFragment)
                .commit()
        }
    }
    ...
    override fun onStart() {
        ...
        fab.setOnClickListener { view ->
            Snackbar.make(view, "TODO add memory", Snackbar.LENGTH_LONG)
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
        when (item.itemId) {
            android.R.id.home -> {
                ...
                navigateUpTo(Intent(this, MemoryListActivity::class.java))
                true
            }
